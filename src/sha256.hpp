...
// charasyn: I have copied the Boost Software License 1.0 full text as obtained
// from the URL above for convenience. No other modifications have been made to
// this file.
